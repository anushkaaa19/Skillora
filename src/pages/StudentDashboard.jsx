                  ...
                  <div className="border-b border-space-light p-6 bg-gradient-to-r from-space-accent/20 to-space-secondary/20">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Issued by {certificate.instructor}</p>
                      </div>
                      <div className="text-gray-400 text-sm">{certificate.issueDate}</div>
                    </div>
                  </div>
                  <div className="p-6 flex items-center justify-center space-x-4">
                    <Button variant="outline" className="w-full border-space-light text-white">
          ...
          <TabsContent value="progress" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="border-space-light bg-space-light/30 backdrop-blur-sm">
                ...
                <CardContent>
                  {/* Placeholder content */}
                  <p className="text-gray-400">Track your course completion progress here.</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
